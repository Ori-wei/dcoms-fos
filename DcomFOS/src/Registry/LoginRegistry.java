 ...
 * @author User
 */
public class LoginRegistry extends javax.swing.JFrame {

    /**
     * Creates new form LoginRegistry
     */
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        ...
        RegisterRegistry RegisterRegistry = new RegisterRegistry();

        // Set the visibility of the RegisterClient window to true
        RegisterRegistry.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginRegistry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginRegistry().setVisible(true);
            }
        });
    }
