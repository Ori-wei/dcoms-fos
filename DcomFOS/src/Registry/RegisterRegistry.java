 ...
 * @author User
 */
public class RegisterRegistry extends javax.swing.JFrame {

    /**
     * Creates new form RegisterRegistry
     */
    public RegisterRegistry() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterRegistry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterRegistry().setVisible(true);
            }
        });
    }
